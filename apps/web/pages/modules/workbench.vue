  ...
  <div class="placeholder-page">
    <section class="placeholder-hero">
      <div class="placeholder-hero-inner">
        ...
        <h1>漫剧工作台</h1>
        <p class="hero-desc">进入具体项目的分镜、素材生成和配音环节，结构化推进漫画内容生产。</p>
      </div>
    </section>
    ...
    <section class="placeholder-content">
      <div class="placeholder-card">
        ...
        <h2>漫剧工作台正在建设中</h2>
        <p>这里将提供以阶段为单位的生产工作台，左侧阶段导航，中间主工作区，右侧状态与缺口说明。</p>
        <p>预计支持：分镜编辑、素材管理、配音分配、批量生成与状态追踪。</p>

        <div class="coming-features">
          <div class="feature-item">
            <strong>阶段导航</strong>
            <span>导入→整理→生成→校验→导出分步推进</span>
          </div>
          <div class="feature-item">
            <strong>分镜编辑</strong>
            <span>可视化编排漫画分镜和镜头顺序</span>
          </div>
          <div class="feature-item">
            <strong>素材生成</strong>
            <span>批量生成角色、场景和道具素材</span>
          </div>
        </div>
